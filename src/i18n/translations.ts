...
export const dict = {
  en: {
    ...
    'sync.help.body':
      'Create a free private bin at jsonbin.io, then generate a bin-scoped Access Key. Paste the Bin ID and Access Key above. On another device, enter the same values to sync.',
  ...
  es: {
    ...
    'sync.help.body':
      'Crea un bin privado gratuito en jsonbin.io y genera una clave de acceso limitada a ese bin. Pega el ID del bin y la clave de acceso arriba. En otro dispositivo, introduce los mismos valores para sincronizar.',
